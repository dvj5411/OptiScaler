                               ...
                               const void** ppvContext)
{
    if (dwObjectType == CERT_QUERY_OBJECT_FILE && pvObject)
    {
        ...
        if ((pathString.contains("amd_fidelityfx_dx12.dll") || pathString.contains("amd_fidelityfx_loader_vk.dll") ||
             pathString.contains("amd_fidelityfx_upscaler_vk.dll") || pathString.contains("amd_fidelityfx_vk.dll")) &&
